...
export default function Hero() {
  return (
    <section className="mx-auto px-6 pt-20 pb-24">
      ...
      <div className="flex flex-col-reverse items-center justify-between gap-14 lg:flex-row">
        ...
        <div className="flex-1">
          ...
          <h1 className="mt-5 text-4xl font-bold leading-tight tracking-tight text-zinc-900 dark:text-white lg:text-6xl">
            Hi, I&apos;m <span className="text-orange-500">Manishkumar</span> 👋
          </h1>

          <p className="mt-6 max-w-xl text-lg leading-9 text-zinc-600 dark:text-zinc-400">
      ...
      <div className="mt-24">
        ...
        <div className="mt-6 rounded-3xl border border-zinc-200/50 bg-white/40 p-8 shadow-sm backdrop-blur-xl dark:border-zinc-800 dark:bg-zinc-900/40">
